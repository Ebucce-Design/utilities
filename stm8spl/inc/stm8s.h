...
/////////////
// Type definition is moved to a separate file "types.h" to be able to use it 
// without reference to any stm8-realated code. To avoid multiple compiler warnings
// type definitions in this file were replaced with an include of forementioned file
